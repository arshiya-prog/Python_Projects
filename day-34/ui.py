...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true = tk.PhotoImage(file="day-34/images/true.png")
        self.true_button = tk.Button(image=self.true, highlightthickness=0, highlightbackground=THEME_COLOR, command=self.correct)
        self.true_button.config(padx=20, pady=20)
        self.true_button.grid(row=2, column=0)

        self.false = tk.PhotoImage(file="day-34/images/false.png")
        self.false_button = tk.Button(image=self.false, highlightthickness=0, highlightbackground=THEME_COLOR, command=self.wrong)
